...
fun StartOrderScreen(
    durationOptions: List<Pair<Int, Int>>,
    ...
    Column(
        ...
        Column(
            ...
            Image(
                painter = painterResource(R.drawable.youtube_premium_logo),
                contentDescription = null,
                modifier = Modifier.width(300.dp)
            )
            Spacer(modifier = Modifier.height(dimensionResource(R.dimen.padding_medium)))
            Text(
                text = stringResource(R.string.youtube_premium),
